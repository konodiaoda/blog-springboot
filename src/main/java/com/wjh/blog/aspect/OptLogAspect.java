...
import com.wjh.blog.dao.OperationLogDao;
...
public class OptLogAspect {
     ...
     */
    @Pointcut("@annotation(com.wjh.blog.annotation.OptLog)")
    ...
    public void saveOptLog(JoinPoint joinPoint, Object keys) {
        ...
        // 请求参数
        operationLog.setRequestParam(JsonUtils.obj2StringPretty(joinPoint.getArgs()));
        // 返回结果
        operationLog.setResponseData(JsonUtils.obj2StringPretty(keys));
        // 请求用户ID
