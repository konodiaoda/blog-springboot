...
import com.wjh.blog.dao.UserRoleDao;
import com.wjh.blog.dto.RoleDTO;
import com.wjh.blog.dto.UserRoleDTO;
import com.wjh.blog.entity.Role;
import com.wjh.blog.entity.RoleMenu;
import com.wjh.blog.entity.RoleResource;
import com.wjh.blog.entity.UserRole;
import com.wjh.blog.exception.BizException;
import com.wjh.blog.handler.FilterInvocationSecurityMetadataSourceImpl;
import com.wjh.blog.service.RoleMenuService;
...
public class RoleServiceImpl extends ServiceImpl<RoleDao, Role> implements RoleService {
    ...
    public void saveOrUpdateRole(RoleVO roleVO) {
        ...
        //判断是新增还是修改
        if (Objects.nonNull(existRole) &&!Objects.equals(existRole.getId(),roleVO.getId())) {
